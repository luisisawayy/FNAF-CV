"""
binds_fnaf1.py - Contains the logic for handling keyboard bindings and mapping them to FNAF 1 actions based
on inference results from the computer vision gesture model.

Usage:
    python binds_fnaf1.py
"""
import pyautogui
import time
import keyboard
...
def start_udp_server():
    ...
    print(f"\n[NETWORK] FNAF 1 Server actively listening on port {UDP_PORT}...")
